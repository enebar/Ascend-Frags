...
RMenu.Add('CLIMBGarages', 'main', RageUI.CreateMenu("", "~d~ Garages",1300, 50, "banners", "garages"))
RMenu.Add('CLIMBGarages', 'owned_vehicles',  RageUI.CreateSubMenu(RMenu:Get("CLIMBGarages", "main")))
RMenu.Add('CLIMBGarages', 'rented_vehicles',  RageUI.CreateSubMenu(RMenu:Get("CLIMBGarages", "main")))
RMenu.Add('CLIMBGarages', 'rented_vehicles_manage',  RageUI.CreateSubMenu(RMenu:Get("CLIMBGarages", "rented_vehicles")))
RMenu.Add('CLIMBGarages', 'owned_vehicles_submenu',  RageUI.CreateSubMenu(RMenu:Get("CLIMBGarages", "owned_vehicles")))
RMenu.Add('CLIMBGarages', 'owned_vehicles_submenu_manage',  RageUI.CreateSubMenu(RMenu:Get("CLIMBGarages", "owned_vehicles_submenu")))
RMenu.Add('CLIMBGarages', 'scrap_vehicle_confirmation',  RageUI.CreateSubMenu(RMenu:Get("CLIMBGarages", "owned_vehicles_submenu_manage")))
RMenu.Add('CLIMBGarages', 'rented_vehicles_out_manage',  RageUI.CreateSubMenu(RMenu:Get("CLIMBGarages", "rented_vehicles")))
RMenu.Add('CLIMBGarages', 'rented_vehicles_out_manage_submenu',  RageUI.CreateSubMenu(RMenu:Get("CLIMBGarages", "rented_vehicles_out_manage")))
RMenu:Get('CLIMBGarages', 'owned_vehicles'):SetSubtitle("~w~Vehicle Categories")
RMenu:Get('CLIMBGarages', 'scrap_vehicle_confirmation'):SetSubtitle("~w~Are you sure you want to scrap this vehicle?")
RMenu.Add('CLIMBGarages', 'customfolders',  RageUI.CreateSubMenu(RMenu:Get("CLIMBGarages", "owned_vehicles")))
RMenu.Add('CLIMBGarages', 'customfolderscate',  RageUI.CreateSubMenu(RMenu:Get("CLIMBGarages", "customfolders")))
RMenu.Add('CLIMBGarages', 'removecarcustomfolders',  RageUI.CreateSubMenu(RMenu:Get("CLIMBGarages", "main")))
RMenu.Add('CLIMBGarages', 'addcarcustomfolders',  RageUI.CreateSubMenu(RMenu:Get("CLIMBGarages", "main")))
...
-- Did you know you can toggle most things in CLIMB within the CLIMB/sharedcfg/options.lua?
RageUI.CreateWhile(1.0, true, function()
    if RageUI.Visible(RMenu:Get('CLIMBGarages', 'main')) then
            ...
            RageUI.ButtonWithStyle("Owned Vehicles", "", {}, true, function(Hovered, Active, Selected) 
                if Selected then 
                    if Table_Type == nil or not Table_Type then 
                        Table_Type = true;
                        TriggerServerEvent('CLIMB:FetchCars', true, garage_type)
                        TriggerServerEvent('CLIMB:FetchFolders')
                        
                    end
                end
            end, RMenu:Get("CLIMBGarages", "owned_vehicles"))
            RageUI.ButtonWithStyle("Rented Vehicles", nil, {}, true, function(Hovered, Active, Selected) end, RMenu:Get("CLIMBGarages", "rented_vehicles"))
            RageUI.ButtonWithStyle("Store Vehicle", nil, {}, true, function(Hovered, Active, Selected) 
                if Selected then 
                    tCLIMB.despawnGarageVehicle(garage_type,CLIMBConfig.VehicleStoreRadius)
                end
            end)
        end)
    end
    if RageUI.Visible(RMenu:Get('CLIMBGarages', 'owned_vehicles')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            DeleteCar(veh)
            RentedVeh = false;
            ...
            end, RMenu:Get("CLIMBGarages", "customfolders"))
            for i,v in pairs(VehiclesFetchedTable) do 
               if garage_type == VehiclesFetchedTable[i].config.vtype or  garage_type == VehiclesFetchedTable[i].config.vtype2 or  garage_type == VehiclesFetchedTable[i].config.vtype3 then
                    ...
                    end, RMenu:Get("CLIMBGarages", "owned_vehicles_submenu"))
                end
            end
        end)
    end
    if RageUI.Visible(RMenu:Get('CLIMBGarages', 'customfolders')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
                ...
                if Selected then
                    ...
                    if FolderName ~= nil then
                        if Folders[FolderName] == nil then
                            Folders[FolderName] = {}
                            TriggerServerEvent("CLIMB:UpdateFolders", Folders)
                        else
            ...
            for h,b in pairs(Folders) do
                ...
                end, RMenu:Get("CLIMBGarages", "customfolderscate"))
            end
    
        end)
    end
    
    if RageUI.Visible(RMenu:Get('CLIMBGarages', 'customfolderscate')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
                        ...
                        for a,b in pairs(VehiclesFetchedTable) do 
                            for c,d in pairs(b.vehicles) do
                                if c == v[i] then
                                    ...
                                    end,RMenu:Get("CLIMBGarages", "owned_vehicles_submenu_manage")) 
                                end
                            end
                        end
                end
    ...
    if RageUI.Visible(RMenu:Get('CLIMBGarages', 'addcarcustomfolders')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            if #Folders ~= nil then
                for h,b in pairs(Folders) do
                    RageUI.ButtonWithStyle("["..h.."]" , "", {}, true, function(Hovered, Active, Selected)
                    ...
                    end, RMenu:Get("CLIMBGarages", "main"))
                end
            else
    ...
    if RageUI.Visible(RMenu:Get('CLIMBGarages', 'removecarcustomfolders')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            if #Folders ~= nil then
                for h,b in pairs(Folders) do
                    RageUI.ButtonWithStyle("["..h.."]" , "", {}, true, function(Hovered, Active, Selected)
    ...
    if RageUI.Visible(RMenu:Get('CLIMBGarages', 'owned_vehicles_submenu')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
                ...
                if RentedVeh then 
                    RageUI.ButtonWithStyle(v[1], v[2] .. " until the vehicle is returned.", {}, true, function(Hovered, Active, Selected)
                        if Selected then 
                            ...
                            RMenu:Get('CLIMBGarages', 'owned_vehicles_submenu_manage'):SetSubtitle("~d~" .. v[1])
                        end
                        if Active then 
                            Hovered_Vehicles = i
                        end
    ...
    if RageUI.Visible(RMenu:Get('CLIMBGarages', 'owned_vehicles_submenu_manage')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            RageUI.ButtonWithStyle("~g~[Add Vehicle]" , "~y~Add current vehicle to custom folder", {}, true, function(Hovered, Active, Selected)
                if Selected then

                end
            end, RMenu:Get("CLIMBGarages", "addcarcustomfolders"))
            ...
            end, RMenu:Get("CLIMBGarages", "removecarcustomfolders"))
            RageUI.ButtonWithStyle('Spawn Vehicle', "", {}, true, function(Hovered, Active, Selected)
                if Selected then 
                    tCLIMB.spawnGarageVehicle(garage_type, SelectedCar.spawncode, GetEntityCoords(PlayerPedId()), SelectedCar.name, SelectedCar.plate)
            ...
            if not RentedVeh then 
                RageUI.ButtonWithStyle('Scrap Vehicle', "", {}, true, function(Hovered, Active, Selected)end,RMenu:Get("CLIMBGarages", "scrap_vehicle_confirmation"))
                RageUI.ButtonWithStyle('Rent out Vehicle', "", {}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent('CLIMB:RentVehicle', SelectedCar.spawncode) 
                    end
                    if Active then 
                ...
                RageUI.ButtonWithStyle('Sell Vehicle', "", {}, true, function(Hovered, Active, Selected)
                    if Selected then 
                        TriggerServerEvent('CLIMB:SellVehicle', SelectedCar.spawncode)
                    end
                    if Active then 
    ...
    if RageUI.Visible(RMenu:Get('CLIMBGarages', 'scrap_vehicle_confirmation')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            RageUI.ButtonWithStyle('Yes', "WARNING: THIS WILL DESTROY YOUR VEHICLE THIS IS NOT REVERSIBLE.", {}, true, function(Hovered, Active, Selected)
                if Selected then
                    TriggerServerEvent('CLIMB:ScrapVehicle', SelectedCar.spawncode) 
                    Table_Type = nil;
                    RageUI.ActuallyCloseAll()
                    RageUI.Visible(RMenu:Get('CLIMBGarages', 'main'), true)  
                end
            end)
            RageUI.ButtonWithStyle('No', "", {}, true, function(Hovered, Active, Selected)end,RMenu:Get("CLIMBGarages", "owned_vehicles_submenu_manage"))
        end)
    end
    if RageUI.Visible(RMenu:Get('CLIMBGarages', 'rented_vehicles')) then 
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            DeleteCar(veh)
            RageUI.ButtonWithStyle('Rented Vehicles Out', "", {}, true, function(Hovered, Active, Selected)
                if Selected then
                    Table_Type = nil;
                    TriggerServerEvent('CLIMB:FetchVehiclesOut')
                end
            end,RMenu:Get("CLIMBGarages", "rented_vehicles_out_manage"))
            RageUI.ButtonWithStyle('Rented Vehicles In', "", {}, true, function(Hovered, Active, Selected)
                if Selected then
                    Table_Type = nil;
                    RentedVeh = true;
                    TriggerServerEvent('CLIMB:FetchVehiclesIn')
                end
            end,RMenu:Get("CLIMBGarages", "rented_vehicles_manage"))
        end)
    end
    if RageUI.Visible(RMenu:Get('CLIMBGarages', 'rented_vehicles_out_manage')) then 
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            Hovered_Vehicles = nil 
            DeleteCar(veh)
            for i,v in pairs(VehiclesFetchedTable) do 
               if garage_type == VehiclesFetchedTable[i].config.vtype or  garage_type == VehiclesFetchedTable[i].config.vtype2 or  garage_type == VehiclesFetchedTable[i].config.vtype3 then
                    ...
                    end, RMenu:Get("CLIMBGarages", "rented_vehicles_out_manage_submenu"))
                end
            end
        end)
    end
    if RageUI.Visible(RMenu:Get('CLIMBGarages', 'rented_vehicles_out_manage_submenu')) then 
        RageUI.DrawContent({header = true, glare = false, instructionalButton = true}, function()
            for i,v in pairs(selected_category) do 
    ...
    if RageUI.Visible(RMenu:Get('CLIMBGarages', 'rented_vehicles_manage')) then 
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            Hovered_Vehicles = nil 
            DeleteCar(veh)
            for i,v in pairs(VehiclesFetchedTable) do 
...
if CLIMBConfig.LoadPreviews then 
            ...
            if Hovered_Vehicles then 
                ...
                if not DoesEntityExist(veh) and not IsPedInAnyVehicle(PlayerPedId(), false) and not cantload[Hovered_Vehicles] and Hovered_Vehicles then
                    ...
                    while not HasModelLoaded(hash) do
                        ...
                        Citizen.Wait(10)
                        if i > 30 then
                           tCLIMB.notify('~d~Model could not be loaded!') 
                            if vehname then 
...
RegisterNetEvent('CLIMB:ReturnFetchedCars')
AddEventHandler('CLIMB:ReturnFetchedCars', function(table)
    VehiclesFetchedTable = table;
end)

RegisterNetEvent('CLIMB:ReturnFolders')
AddEventHandler('CLIMB:ReturnFolders', function(Fodlers)
    Folders = Fodlers;
...
RegisterNetEvent('CLIMB:CloseGarage')
AddEventHandler('CLIMB:CloseGarage', function()
    DeleteCar(veh)
    Table_Type = nil;
    RageUI.ActuallyCloseAll()
end)
