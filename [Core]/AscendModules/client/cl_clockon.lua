...
--                 if Selected then
--                     TriggerServerEvent('CLIMB:Clockon', p.group)
--                     TriggerEvent('CLIMB:policeRemove')
--                     TriggerServerEvent("CLIMB:PoliceCheckRadial")
--                 end
--             end)
--         end
...
-- RegisterNetEvent('CLIMB:policeRemove')
-- AddEventHandler('CLIMB:policeRemove', function()
--     local source = source
