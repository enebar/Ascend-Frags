...
tCLIMB.createThreadOnTick(func_playerlistControl)
...
function sendFullPlayerListData()
    ...
    SendNUIMessage({setServerMetaData = '<img src="playerlist_images/climb.png" align="top" width="20px",height="20px"><span class="staff">' ..tostring(H) .. "</span>"})
...
--             SetDiscordRichPresenceAsset('vrtx') 
--             SetDiscordRichPresenceAssetText("discord.gg/vrtxfivem") 
--             SetDiscordRichPresenceAssetSmall('vrtxsmall')
