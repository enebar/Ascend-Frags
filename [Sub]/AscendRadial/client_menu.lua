...
Citizen.CreateThread(function()
    TriggerServerEvent("CLIMBRP:PoliceCheckRadial")
    TriggerServerEvent("CLIMBRP:NHSCheckRadial")
end)
...
function Crosshair(enable)
    TriggerEvent("CLIMBRP:PutCrossHairOnScreen", enable)
    Display = enable;
end
...
RegisterNetEvent("CLIMBRP:CleanCar")
AddEventHandler("CLIMBRP:CleanCar",function()
