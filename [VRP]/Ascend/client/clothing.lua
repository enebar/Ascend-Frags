...
RMenu.Add('CLIMBClothing', 'main', RageUI.CreateMenu("", "~d~ Clothing Menu",1300, 100, "banners", "clothes"))
...
RMenu.Add('CLIMBClothing', 'changepedmenu',  RageUI.CreateSubMenu(RMenu:Get("CLIMBClothing", "main")))
RMenu.Add('CLIMBClothing', 'wardrobesub',  RageUI.CreateSubMenu(RMenu:Get("CLIMBClothing", "main")))
RMenu.Add('wardrobesub', 'clothingsub',  RageUI.CreateSubMenu(RMenu:Get("CLIMBClothing", "wardrobesub")))
...
RageUI.CreateWhile(1.0, true, function()
    ...
    if RageUI.Visible(RMenu:Get('CLIMBClothing', 'main')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            RageUI.ButtonWithStyle("Change Clothing", nil, {}, true, function(Hovered, Active, Selected) end, RMenu:Get("CLIMBClothing", "clothingsubmenu"))
            RageUI.ButtonWithStyle("Change Gender", nil, {}, true, function(Hovered, Active, Selected) end, RMenu:Get("CLIMBClothing", "changegendersubmenu"))
            RageUI.ButtonWithStyle("Change Ped", nil, {}, true, function(Hovered, Active, Selected) end, RMenu:Get("CLIMBClothing", "changepedmenu"))
            --RageUI.ButtonWithStyle("Wardrobe", nil, {}, true, function(Hovered, Active, Selected) end, RMenu:Get("CLIMBClothing", "wardrobesub"))
        end)
    end
    ...
    if RageUI.Visible(RMenu:Get('CLIMBClothing', 'wardrobesub')) then 
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
    ...
    if RageUI.Visible(RMenu:Get('wardrobesub', 'clothingsub')) then 
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
                ...
                if Selected then
                    for k, v in pairs(wardrobe) do
                        if k == currentOutfit then
                            ...
                            tCLIMB.setCustomization(v)

                            SetTimeout(50, function()
                                SetPedArmour(PlayerPedId(), savedArmour)
                                TriggerServerEvent('CLIMB:changeHairStyle')
                            end)
            ...
            end, RMenu:Get('CLIMBClothing', 'wardrobesub'))
    ...
    if RageUI.Visible(RMenu:Get('CLIMBClothing', 'changepedmenu')) then 
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
