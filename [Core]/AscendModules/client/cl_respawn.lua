local Housing = module("CLIMBModules", "cfg/cfg_homes")
...
RegisterNetEvent("CLIMB:PolicePerms")
AddEventHandler("CLIMB:PolicePerms",function(pd)
    hasPD = pd
end)
RegisterNetEvent("CLIMB:RebelPerms")
AddEventHandler("CLIMB:RebelPerms",function(rebel)
    hasRebel = rebel
end)
RegisterNetEvent("CLIMB:VIPPerms")
AddEventHandler("CLIMB:VIPPerms",function(vip)
    hasVIP = vip
end)
...
RegisterNetEvent("CLIMB:StartRespawnCam")
AddEventHandler("CLIMB:StartRespawnCam",function()
    inRedZone = false
    inCam = true
    inMenu = true
    DoScreenFadeIn(500)
...
RegisterNetEvent("CLIMB:HousingTable")
AddEventHandler("CLIMB:HousingTable",function(houses)
    housetable = houses
end)