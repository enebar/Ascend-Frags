...
RegisterCommand("openphone", function()
  TriggerEvent("CLIMB:phoneToggledDvsa")
  if GetEntityHealth(PlayerPedId()) <= 102 then return end
  if takePhoto ~= true then
      TogglePhone()
  end
  TriggerServerEvent('CLIMB:getGarageFolders')
end)
...
--====================================================================================
RegisterNetEvent('CLIMB:setEnableApp')
AddEventHandler('CLIMB:setEnableApp', function(appName, enable)
...
RegisterNetEvent("CLIMB:forceOpenPhone")
AddEventHandler("CLIMB:forceOpenPhone", function(_myPhoneNumber)
...
--  Events
--====================================================================================
RegisterNetEvent("CLIMB:myPhoneNumber")
AddEventHandler("CLIMB:myPhoneNumber", function(_myPhoneNumber)
  myPhoneNumber = _myPhoneNumber
  SendNUIMessage({event = 'updateMyPhoneNumber', myPhoneNumber = myPhoneNumber})
end)

RegisterNetEvent("CLIMB:contactList")
AddEventHandler("CLIMB:contactList", function(_contacts)
  SendNUIMessage({event = 'updateContacts', contacts = _contacts})
  contacts = _contacts
end)

RegisterNetEvent("CLIMB:allMessage")
AddEventHandler("CLIMB:allMessage", function(allmessages)
  SendNUIMessage({event = 'updateMessages', messages = allmessages})
  messages = allmessages
end)


RegisterNetEvent("CLIMB:receiveMessage")
AddEventHandler("CLIMB:receiveMessage", function(message)
  ...
  if not globalIsDND then
    if message.owner == 0 then
      ...
      exports["CLIMB"]:playSound("iphone_ping")
    end
  end
end)
...
function addContact(display, num)
    TriggerServerEvent('CLIMB:addContact', display, num)
end

function deleteContact(num)
    TriggerServerEvent('CLIMB:deleteContact', num)
end
--====================================================================================
--  Function client | Messages
--====================================================================================
function sendMessage(num, message)
  TriggerServerEvent('CLIMB:sendMessage', num, message)
end

function deleteMessage(msgId)
  print("msgId", msgId)
  TriggerServerEvent('CLIMB:deleteMessage', msgId)
...
function deleteMessageContact(num)
  TriggerServerEvent('CLIMB:deleteMessageNumber', num)
end

function deleteAllMessage()
  TriggerServerEvent('CLIMB:deleteAllMessage')
end

function setReadMessageNumber(num)
  TriggerServerEvent('CLIMB:setReadMessageNumber', num)
  for k, v in ipairs(messages) do
...
function requestAllMessages()
  TriggerServerEvent('CLIMB:requestAllMessages')
end

function requestAllContact()
  TriggerServerEvent('CLIMB:requestAllContact')
end
...
RegisterNetEvent("CLIMB:waitingCall")
AddEventHandler("CLIMB:waitingCall", function(infoCall, initiator)
...
RegisterNetEvent("CLIMB:onClientSpawn")
AddEventHandler("CLIMB:onClientSpawn", function(user_id, first_spawn)
    if first_spawn then
...
AddEventHandler("CLIMB:acceptCall", function(infoCall, initiator)
...
RegisterNetEvent("CLIMB:rejectCall")
AddEventHandler("CLIMB:rejectCall", function(infoCall)
  if inCall == true then
    inCall = false
    PhonePlayText()
    if Config.UseMumbleVoIP then
...
RegisterNetEvent("CLIMB:sendCallHistory")
AddEventHandler("CLIMB:sendCallHistory", function(historique)
...
function startCall (phone_number, rtcOffer, extraData)
  ...
  TriggerServerEvent('CLIMB:startCall', phone_number, rtcOffer, extraData)
end

function acceptCall (infoCall, rtcAnswer)
  TriggerServerEvent('CLIMB:acceptCall', infoCall, rtcAnswer)
end

function rejectCall(infoCall)
  TriggerServerEvent('CLIMB:rejectCall', infoCall)
end

function ignoreCall(infoCall)
  TriggerServerEvent('CLIMB:ignoreCall', infoCall)
end

function requestHistoriqueCall()
  TriggerServerEvent('CLIMB:getHistoriqueCall')
end

function appelsDeleteHistorique (num)
  TriggerServerEvent('CLIMB:appelsDeleteHistorique', num)
end

function appelsDeleteAllHistorique ()
  TriggerServerEvent('CLIMB:appelsDeleteAllHistorique')
end
...
RegisterNUICallback('startCall', function (data, cb)
  --exports["CLIMB"]:debugLog("attempting to call:", data.numero)
...
RegisterNUICallback('dnd', function (data, cb)
    --exports["CLIMB"]:debugLog("GOT NUI CALLBACK FOR DND", data.dnd)
...
RegisterNUICallback('onCandidates', function (data, cb)
  TriggerServerEvent('CLIMB:candidates', data.id, data.candidates)
  cb()
end)
...
RegisterNUICallback('sendMessage', function(data, cb)
  ...
  TriggerServerEvent('CLIMB:sendMessage', data.phoneNumber, data.message)
end)
...
RegisterNUICallback('addContact', function(data, cb)
  ...
  TriggerServerEvent('CLIMB:addContact', data.display, data.phoneNumber)
end)
RegisterNUICallback('updateContact', function(data, cb)
  TriggerServerEvent('CLIMB:updateContact', data.id, data.display, data.phoneNumber)
end)
RegisterNUICallback('deleteContact', function(data, cb)
  TriggerServerEvent('CLIMB:deleteContact', data.id)
end)
...
RegisterNUICallback('deleteALL', function(data, cb)
  TriggerServerEvent('CLIMB:deleteALL')
  cb()
end)
...
AddEventHandler('onClientResourceStart', function(res)
  ...
  if res == "CLIMBphone" then
    TriggerServerEvent('CLIMB:allUpdate')
...
RegisterNUICallback("block_number", function(data)
    ...
    TriggerServerEvent("CLIMB:blockNumber", number)
end)
RegisterNUICallback("unblock_number", function(data)
    local number = data.number
    TriggerServerEvent("CLIMB:unBlockNumber", number)
end)
...
RegisterNUICallback("valet_spawn", function(data)
  ...
  if tostring(outPosTarget) ~= "vector3(0, 0, 0)" and tostring(outPos) ~= "vector3(0, 0, 0)" then
      TriggerServerEvent("CLIMB:valetSpawnVehicle", data.spawncode)
  else
