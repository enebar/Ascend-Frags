...
RMenu.Add('adminmenu', 'main', RageUI.CreateMenu("", "~b~Admin Menu", tCLIMB.getRageUIMenuWidth(), tCLIMB.getRageUIMenuHeight(), "gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "players", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "main"), "", E..'Admin Player Interaction Menu',tCLIMB.getRageUIMenuWidth(), tCLIMB.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "closeplayers", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "main"), "", E..'Admin Player Interaction Menu',tCLIMB.getRageUIMenuWidth(), tCLIMB.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "staffmembers", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "main"), "", E..'Admin Player Interaction Menu',tCLIMB.getRageUIMenuWidth(), tCLIMB.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "searchoptions", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "main"), "", E..'Admin Player Search Menu',tCLIMB.getRageUIMenuWidth(), tCLIMB.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "functions", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "main"), "", E..'Admin Functions Menu',tCLIMB.getRageUIMenuWidth(), tCLIMB.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "devfunctions", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "main"), "", E..'Dev Functions Menu',tCLIMB.getRageUIMenuWidth(), tCLIMB.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "communitypot", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "functions"), "", E..'Community Pot',tCLIMB.getRageUIMenuWidth(), tCLIMB.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "moneymenu", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "functions"), "", E..'Money Menu',tCLIMB.getRageUIMenuWidth(), tCLIMB.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "submenu", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "players"), "", E..'Admin Player Interaction Menu',tCLIMB.getRageUIMenuWidth(), tCLIMB.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "searchname", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "searchoptions"), "", E..'Admin Player Search Menu',tCLIMB.getRageUIMenuWidth(), tCLIMB.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "searchtempid", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "searchoptions"), "", E..'Admin Player Search Menu',tCLIMB.getRageUIMenuWidth(), tCLIMB.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "searchpermid", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "searchoptions"), "", E..'Admin Player Search Menu',tCLIMB.getRageUIMenuWidth(), tCLIMB.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "searchhistory", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "searchoptions"), "", E..'Admin Player Search Menu',tCLIMB.getRageUIMenuWidth(), tCLIMB.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "notespreviewban", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "players"), "", E..'Player Notes',tCLIMB.getRageUIMenuWidth(), tCLIMB.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "banselection", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "notespreviewban"), "", E..'Ban Menu ~w~- ~o~[Tab] to search bans',tCLIMB.getRageUIMenuWidth(), tCLIMB.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "generatedban", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "banselection"), "", E..'Ban Menu',tCLIMB.getRageUIMenuWidth(), tCLIMB.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "notesub", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "players"), "", E..'Player Notes',tCLIMB.getRageUIMenuWidth(), tCLIMB.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "groups", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "submenu"), "", E..'Admin Groups Menu ~w~- ~o~[Tab] to search groups',tCLIMB.getRageUIMenuWidth(), tCLIMB.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "addgroup", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "groups"), "", E..'Admin Groups Menu',tCLIMB.getRageUIMenuWidth(), tCLIMB.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
RMenu.Add("adminmenu", "removegroup", RageUI.CreateSubMenu(RMenu:Get("adminmenu", "groups"), "", E..'Admin Groups Menu',tCLIMB.getRageUIMenuWidth(), tCLIMB.getRageUIMenuHeight(),"gmt_adminui","gmt_adminui"))
...
RegisterNetEvent("CLIMB:ReturnNearbyPlayers")
AddEventHandler("CLIMB:ReturnNearbyPlayers", function(table)
    playersNearby = table
end)
...
Citizen.CreateThread(function()
    while true do
        ...
        if hoveredPlayer ~= nil then
            local playerCoords = GetEntityCoords(tCLIMB.getPlayerPed())
            if tCLIMB.isInSpectate() then
                playerCoords = GetFinalRenderedCamCoord()
            end
            TriggerServerEvent("CLIMB:GetNearbyPlayers", playerCoords, 250)
            Citizen.Wait(1000)
        end
    end
end)
...
RageUI.CreateWhile(1.0, true, function()
    if tCLIMB.getStaffLevel() >= 1 then
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'players')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            for k, v in pairs(players) do
                if not tCLIMB.isUserHidden(v[3]) then
                    RageUI.ButtonWithStyle(v[1] .." ["..v[2].."]", v[1] .. " ("..v[4].." hours) PermID: " .. v[3] .. " TempID: " .. v[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                        if Selected then
                            ...
                            SelectedPerm = v[3]
                            TriggerServerEvent("CLIMB:CheckPov",v[3])
                        end
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
                ...
                RageUI.ButtonWithStyle("Offline Ban","",{RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        tCLIMB.clientPrompt("Perm ID:","",function(a)
                            ...
                            TriggerServerEvent('CLIMB:getNotes', banningPermID)
                        end)
                    end
                ...
                RageUI.ButtonWithStyle("TP To Waypoint", "", {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        ...
                        if DoesBlipExist(WaypointHandle) then
                            ...
                            tCLIMB.notify("~r~You do not have a waypoint set")
                        end
                    end
                end)
            end
            if tCLIMB.getStaffLevel() >= 5 then
                RageUI.ButtonWithStyle("Unban","",{RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent("CLIMB:Unban")
                    end
                end)
            end
            if tCLIMB.getStaffLevel() >= 3 then
                RageUI.ButtonWithStyle("Spawn Taxi", "", {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        local A = GetEntityCoords(tCLIMB.getPlayerPed())
                        tCLIMB.spawnVehicle("taxi",A.x,A.y,A.z,GetEntityHeading(tCLIMB.getPlayerPed()),true,true,true)
                    end
                end)
            end
            if tCLIMB.getStaffLevel() >= 5 then
                RageUI.ButtonWithStyle("Revive All Nearby", "", {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        local D = tCLIMB.getPlayerCoords()
                        for E, S in pairs(GetActivePlayers()) do
                            ...
                            if T ~= -1 and M ~= 0 then
                                ...
                                if #(D - U) < 50.0 then
                                    local V = tCLIMB.clientGetUserIdFromSource(T)
                                    if V > 0 then
                                        TriggerServerEvent('CLIMB:RevivePlayer', GetPlayerServerId(PlayerId()), V, true)
                                    end
                                end
                            end
                        end
            ...
            if tCLIMB.getStaffLevel() >= 10 then
                ...
                RageUI.ButtonWithStyle("Add Car", "", {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent('CLIMB:AddCar')
                    end
                end, RMenu:Get('adminmenu', 'functions'))
                RageUI.Checkbox("Set Globally Hidden","",tCLIMB.isLocalPlayerHidden(),{},function()
                end,function()
                    TriggerServerEvent("CLIMB:setUserHidden", true)
                end,function()
                    TriggerServerEvent("CLIMB:setUserHidden", false)
                end)
            end
        end)
    end
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            if a10 ~= nil and sn ~= nil and sc ~= nil and sb ~= nil and sw ~= nil and sch ~= nil then
                ...
                RageUI.ButtonWithStyle("Bank Balance ~g~+",nil,{RightLabel="→→→"},true,function(w,x,y)
                    if y then
                        tCLIMB.clientPrompt("Amount:","",function(j)
                            if tonumber(j) then
                                TriggerServerEvent('CLIMB:ManagePlayerBank',a10,j,"Increase")
                            else
                ...
                RageUI.ButtonWithStyle("Bank Balance ~r~-",nil,{RightLabel="→→→"},true,function(w,x,y)
                    if y then
                        tCLIMB.clientPrompt("Amount:","",function(j)
                            if tonumber(j) then
                                TriggerServerEvent('CLIMB:ManagePlayerBank',a10,j,"Decrease")
                            else
                                tCLIMB.notify("~r~Invalid Amount")
                            end
                        end)
                ...
                RageUI.ButtonWithStyle("Cash Balance ~g~+~w~",nil,{RightLabel="→→→"},true,function(w,x,y)
                    if y then
                        tCLIMB.clientPrompt("Amount:","",function(l)
                            if tonumber(l) then
                                TriggerServerEvent('CLIMB:ManagePlayerCash',a10,l,"Increase")
                            else
                                tCLIMB.notify("~r~Invalid Amount")
                            end
                        end)
                ...
                RageUI.ButtonWithStyle("Bank Balance ~r~-",nil,{RightLabel="→→→"},true,function(w,x,y)
                    if y then
                        tCLIMB.clientPrompt("Amount:","",function(l)
                            if tonumber(l) then
                                TriggerServerEvent('CLIMB:ManagePlayerCash',a10,l,"Decrease")
                            else
                                tCLIMB.notify("~r~Invalid Amount")
                            end
                        end)
                ...
                RageUI.ButtonWithStyle("Casino Chips ~g~+",nil,{RightLabel="→→→"},true,function(w,x,y)
                    if y then
                        tCLIMB.clientPrompt("Amount:","",function(l)
                            if tonumber(l) then
                                TriggerServerEvent('CLIMB:ManagePlayerChips',a10,l,"Increase")
                            else
                                tCLIMB.notify("~r~Invalid Amount")
                            end
                        end)
                ...
                RageUI.ButtonWithStyle("Casino Chips ~r~-",nil,{RightLabel="→→→"},true,function(w,x,y)
                    if y then
                        tCLIMB.clientPrompt("Amount:","",function(l)
                            if tonumber(l) then
                                TriggerServerEvent('CLIMB:ManagePlayerChips',a10,l,"Decrease")
                            else
                                tCLIMB.notify("~r~Invalid Amount")
                            end
                        end)
            ...
            RageUI.ButtonWithStyle("Choose PermID",nil, { RightLabel = "→→→" }, true, function(w,x,y)
                if y then
                    tCLIMB.clientPrompt("PermID:","",function(j)
                        if tonumber(j) then
                            a10 = tonumber(j)
                            tCLIMB.notify("~g~PermID Set To "..j)
                            TriggerServerEvent('CLIMB:getUserinformation',a10)
                        else
                            tCLIMB.notify("~r~Invalid PermID")
                            a10 = nil
                        end
                    end)
                end
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'communitypot')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            ...
            RageUI.ButtonWithStyle("Deposit","",{RightLabel="→→→"},true,function(e,f,g)
                if g then 
                    tCLIMB.clientPrompt("Enter Amount:","",function(d)
                        if tonumber(d)then 
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'searchpermid')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            if foundMatch == false then
                searchforPermID = tCLIMB.KeyboardInput("Enter Perm ID", "", 10)
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'searchtempid')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            if foundMatch == false then
                searchid = tCLIMB.KeyboardInput("Enter Temp ID", "", 10)
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'searchname')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            if foundMatch == false then
                SearchName = tCLIMB.KeyboardInput("Enter Name", "", 10)
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'submenu')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            hoveredPlayer = nil
            if tCLIMB.isUserHidden(SelectedPlayer[3]) then
            ...
            if tCLIMB.getStaffLevel() >= 1 then
                RageUI.ButtonWithStyle("Player Notes", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent('CLIMB:getNotes', SelectedPlayer[3])
                    end
                ...
                RageUI.ButtonWithStyle("Kick Player", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        ...
                        TriggerServerEvent('CLIMB:KickPlayer', uid, SelectedPlayer[3], SelectedPlayer[2])
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
            end
            if tCLIMB.getStaffLevel() >= 2 then
                ...
                RageUI.ButtonWithStyle("Spectate Player", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        if tonumber(SelectedPlayer[2]) ~= GetPlayerServerId(PlayerId()) then
                            if not tCLIMB.isInSpectate() then
                                inRedZone = false
                                TriggerServerEvent("CLIMB:spectatePlayer", SelectedPlayer[3])
                                inSpectatorAdminMode = true
                                RageUI.Text({message = string.format("Press [E] to stop spectating.")})
                            else
                                tCLIMB.notify("You are already spectating a player.")
                            end
                        else
                            tCLIMB.notify("You cannot spectate yourself.")
                        end
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
            end
            if tCLIMB.getStaffLevel() >= 3 then
                RageUI.ButtonWithStyle("Revive", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        local uid = GetPlayerServerId(PlayerId())
                        TriggerServerEvent('CLIMB:RevivePlayer', uid, SelectedPlayer[3])
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
            end
            if tCLIMB.getStaffLevel() >= 1 then
                RageUI.ButtonWithStyle("Teleport to Player", "Name: " .. SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        ...
                        TriggerServerEvent('CLIMB:TeleportToPlayer', newSource, SelectedPlayer[2])
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
                RageUI.ButtonWithStyle("Teleport Player to Me", "Name: " .. SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent('CLIMB:BringPlayer', SelectedPlayer[2])
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
                RageUI.ButtonWithStyle("Teleport to Admin Zone", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        ...
                        TriggerServerEvent("CLIMB:Teleport2AdminIsland", SelectedPlayer[2])
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
                RageUI.ButtonWithStyle("Teleport Back from Admin Zone", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent("CLIMB:TeleportBackFromAdminZone", SelectedPlayer[2], savedCoordsBeforeAdminZone)
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
                RageUI.ButtonWithStyle("Teleport to Legion", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent("CLIMB:Teleport2Legion", SelectedPlayer[2])
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
                RageUI.ButtonWithStyle("Freeze", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        ...
                        TriggerServerEvent('CLIMB:FreezeSV', uid, SelectedPlayer[2], isFrozen)
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
            end
            if tCLIMB.getStaffLevel() >= 5 then
                RageUI.ButtonWithStyle("Slap Player", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        local uid = GetPlayerServerId(PlayerId())
                        TriggerServerEvent('CLIMB:SlapPlayer', uid, SelectedPlayer[2])
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
                RageUI.ButtonWithStyle("Force Clock Off", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent('CLIMB:ForceClockOff', SelectedPlayer[2])
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
            end
            if tCLIMB.getStaffLevel() >= 1 then
            ...
            if tCLIMB.getStaffLevel() >= 2 then
                RageUI.ButtonWithStyle("Take Screenshot", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        local uid = GetPlayerServerId(PlayerId())
                        TriggerServerEvent('CLIMB:RequestScreenshot', uid , SelectedPlayer[2])
                    end
                end, RMenu:Get('adminmenu', 'submenu'))
                RageUI.Button("Take Video", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], requestedVideo and {RightLabel = ""} or {RightLabel = "→→→"}, not requestedVideo, function(Hovered, Active, Selected)
                    if Selected then
                        local uid = GetPlayerServerId(PlayerId())
                        TriggerServerEvent('CLIMB:RequestVideo', uid, SelectedPlayer[2])
                        requestedVideo = true
            ...
            if tCLIMB.getStaffLevel() >= 6 then
                RageUI.ButtonWithStyle("Request Account Info", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent("CLIMB:requestAccountInfosv", SelectedPlayer[3])
                    end
                end,RMenu:Get("adminmenu", "submenu"))
                RageUI.ButtonWithStyle("See Groups", --[["~r~This is moderator+ ~w~Name: " ..]] SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent("CLIMB:GetGroups", SelectedPlayer[3])
                        tt=''
                    end
                end,RMenu:Get("adminmenu", "groups"))
            end
            if tCLIMB.getStaffLevel() >= 12 then
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            if tCLIMB.getStaffLevel() >= 2 then
                if IsControlJustPressed(0, 37) then
                    tCLIMB.clientPrompt("Search for: ","",function(O)
                        if O ~= "" then
                            o = string.lower(O)
                        else
                            o = nil
                ...
                RageUI.ButtonWithStyle("Confirm Ban", "", {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent("CLIMB:GenerateBan", banningPermID, selectedbans)
                    end
                ...
                if next(selectedbans) then
                    if BanMessage == "N/A" then
                        ...
                        RageUI.ButtonWithStyle("Confirm", "", {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                            if Selected then
                                TriggerServerEvent("CLIMB:BanPlayer", banningPermID, Duration, BanMessage, BanPoints)
                            end
                        end)
                    end
                else
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            ...
            if tCLIMB.getStaffLevel() >= 1 then
                RageUI.ButtonWithStyle("Add To Notes:", SelectedPlayer[1] .. " Perm ID: " .. SelectedPlayer[3] .. " Temp ID: " .. SelectedPlayer[2], { RightLabel = "→→→" }, true, function(Hovered, Active, Selected)
                    if Selected then
                        tCLIMB.clientPrompt("Add To Notes: ","",function(a7)
                            if a7 ~= "" then
                                if #noteslist ~= 0 then
                                    noteslist[#noteslist + 1] = {id = #noteslist + 1, note = a7, author = tCLIMB.getUserId()}
                                else
                                    noteslist = {{id = 1, note = a7, author = tCLIMB.getUserId()}}
                                end
                                TriggerServerEvent("CLIMB:updatePlayerNotes", SelectedPlayer[3], noteslist)
                            end
                        end)
                    end
                end)
                RageUI.ButtonWithStyle("Remove Note", nil, { RightLabel = "→→→" }, true, function(Hovered, Active, Selected)
                    if Selected then
                        tCLIMB.clientPrompt("Type the ID of the note","",function(a7)
                            if a7 ~= "" then
                                a7 = tonumber(a7)
                                local a8 = {}
                                local a9 = false
                                ...
                                if a9 == true then
                                    ...
                                    TriggerServerEvent("CLIMB:updatePlayerNotes", SelectedPlayer[3], a8)
                                end
                            end
                        end)
                    end
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'groups')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            if tCLIMB.getStaffLevel() >= 7 then
                if IsControlJustPressed(0, 37) then
                    tCLIMB.clientPrompt("Search for: ","",function(S)
                        tt=string.lower(S)
                    end)
                end
    ...
    if RageUI.Visible(RMenu:Get('adminmenu', 'addgroup')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            RageUI.ButtonWithStyle("Add this group to user", "", { RightLabel = "→→→" }, true, function(Hovered, Active, Selected)
                if Selected then
                    TriggerServerEvent("CLIMB:AddGroup",SelectedPerm,selectedGroup)
                end
            end, RMenu:Get('adminmenu', 'groups'))
        end)
    end
    if RageUI.Visible(RMenu:Get('adminmenu', 'removegroup')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            RageUI.ButtonWithStyle("Remove user from group", "", { RightLabel = "→→→" }, true, function(Hovered, Active, Selected)
                if Selected then
                    TriggerServerEvent("CLIMB:RemoveGroup",SelectedPerm,selectedGroup)
                end
            end, RMenu:Get('adminmenu', 'groups')) 
        end)
    end
...
RegisterCommand("cleanup", function()
    TriggerServerEvent('CLIMB:CleanAll')
end)

RegisterNetEvent('CLIMB:SlapPlayer')
AddEventHandler('CLIMB:SlapPlayer', function()
    SetEntityHealth(PlayerPedId(), 0)
end)


frozen = false
RegisterNetEvent("CLIMB:Freeze",function()
    local Q = tCLIMB.getPlayerPed()
    ...
    if not frozen then
        ...
        frozen = true
        while frozen do
            tCLIMB.setWeapon(Q, "WEAPON_UNARMED", true)
            Wait(0)
        end
    else
...
RegisterNetEvent("CLIMB:sendNotes",function(a7)
    a7 = json.decode(a7)
    if a7 == nil then
        noteslist = {}
    else
...
RegisterNetEvent('CLIMB:ReturnPov')
AddEventHandler('CLIMB:ReturnPov', function(pov)
    povlist = pov
end)

RegisterNetEvent("CLIMB:GotGroups")
AddEventHandler("CLIMB:GotGroups",function(gotGroups)
    searchPlayerGroups = gotGroups
end)

RegisterNetEvent("CLIMB:getPlayersInfo")
AddEventHandler("CLIMB:getPlayersInfo", function(BB, preasons)
    players = BB
    banreasons = preasons
    RageUI.Visible(RMenu:Get("adminmenu", "main"), not RageUI.Visible(RMenu:Get("adminmenu", "main")))
end)

RegisterNetEvent("CLIMB:RecieveBanPlayerData")
AddEventHandler("CLIMB:RecieveBanPlayerData",function(BanDuration, CollectedBanMessage, SepMSG, points)
...
RegisterNetEvent("CLIMB:receivedUserInformation")
AddEventHandler("CLIMB:receivedUserInformation", function(us,un,ub,uw,uc)
    if us == nil or un == nil or ub == nil or uw == nil or uc == nil then
        a10 = nil
        tCLIMB.notify("~r~Player does not exist.")
        return
    end
    sc=us
    sn=un
...
RegisterNetEvent("CLIMB:gotCommunityPotAmount",function(d)
...
RegisterNetEvent('CLIMB:OpenAdminMenu')
AddEventHandler('CLIMB:OpenAdminMenu', function(admin)
    if admin then
        TriggerServerEvent('CLIMB:GetPlayerData')
        TriggerServerEvent("CLIMB:GetNearbyPlayerData")
        TriggerServerEvent("CLIMB:getAdminLevel")
    end
end)

RegisterCommand('devmenu',function()
    if tCLIMB.isDev() then
...
function func_checkSpectatorMode()
    if inSpectatorAdminMode then
        if IsControlJustPressed(0, 51) then
            ...
            TriggerServerEvent("CLIMB:stopSpectatePlayer")
        end
    end
end
tCLIMB.createThreadOnTick(func_checkSpectatorMode)


RegisterNetEvent("CLIMB:takeClientScreenshotAndUpload",function(url)
    local url = url -- need a custom uploader whenever
    exports["screenshot-basic"]:requestScreenshotUpload(url,"files[]",function(ab)
    end)
end)

RegisterNetEvent("CLIMB:takeClientVideoAndUpload",function(url)
    local url = url  -- need a custom uploader whenever
...
local function ao()
    ...
    if GetGameTimer() - an > 60000 then
        TriggerServerEvent("CLIMB:acType16")
    end
end
AddEventHandler("CLIMB:onClientSpawn",function(C, D)
    if D then
        an = GetGameTimer()
        while true do
            ao()
...
local aK = false
RegisterNetEvent("CLIMB:adminTicketFeedback",function(aL)
    local aM, aN = tCLIMB.getPlayerVehicle()
    if aM ~= 0 and aN and GetEntitySpeed(aM) > 25.0 or tCLIMB.getPlayerCombatTimer() > 0 then
        return
    end
    if aK then
        return
    ...
    if aO then
        local aP = false
        tCLIMB.clientPrompt("Attached Message","",function(aQ)
            TriggerServerEvent("CLIMB:adminTicketFeedback", aL, aO, aQ)
            aP = true
        end)
        while not aP do
            for a1 = 0, 6 do
        ...
        TriggerServerEvent("CLIMB:adminTicketNoFeedback", aL)
    end
    tCLIMB.showUI()
