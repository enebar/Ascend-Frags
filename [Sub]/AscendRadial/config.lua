...
RegisterNetEvent("CLIMBRP:PoliceClockedOn")
AddEventHandler("CLIMBRP:PoliceClockedOn", function(MetPD)
    onduty = MetPD
end)
...
newSubMenus = {
    ...
    ['vehmenu:lockpick'] = {
        ...
        functionName = "CLIMBRP:LockPick2"
    },
    ['vehmenu:cleancar'] = {
        title = "Clean Your Vehicle",
        icon = "#general-keys-give",
        functionName = "CLIMBRP:CleanCar"
    },

    ['police:cpr'] = {
        title = "CPR",
        icon = "#general-check-over-target",
        functionName = 'CLIMBRP:reviveRadial'
    },
    ...
    ['vehmenupd:clampveh'] = {
        title = "Clamp Vehicle",
        icon = "#car-side",
        functionName = "CLIMBRP:ClampVehicle"
    },  
    ['vehmenupd:unclampveh'] = {
        title = "Unclamp Vehicle",
        icon = "#car-side",
        functionName = "CLIMBRP:UnClampVehicles"
    },  
    ['general:exitmenu'] = {
        title = "Exit Menu",
    ...
    ['general:emotes'] = {
        title = "Store Weapons",
        icon = "#general-emotes",
        functionName = "CLIMBRP:Storeweapons"
    },    
    ['general:askid'] = {
        title = "Ask For ID",
        icon = "#police-vehicle-plate",
        functionName = "CLIMBRP:AskID"
    },
    ['general:searchnearest'] = {
        title = "Search Player",
        icon = "#cuffs-check-inventory",
        functionName = "CLIMBRP:SearchPlr"
    },
    ['general:cpr'] = {
        title = "CPR",
        icon = "",
    ...
    ['general:givemoney'] = {
        ...
        functionName = "CLIMBRP:GiveMoney"
    },
...
--[[     ['general:checkvehicle'] = {
    ...
    ['general:putinvehicle'] = {
        ...
        functionName = "CLIMBRP:PutPlrInVeh"
    },
    ['general:unseatnearest'] = {
        title = "Unseat Nearest",
        icon = "#general-unseat-nearest",
        functionName = "CLIMBRP:TakeOutOfVehicle"
    },    
    ['general:flipvehicle'] = {
        title = "Flip Vehicle",
...
--[[     ['judge-raid:checkowner'] = {
    ...
    ['cuffs:cuff'] = {
        title = "Cuff",
        icon = "#cuffs-cuff",
        functionName = "CLIMBRP:policeCuff"
    }, 
    ...
    ['police:jail'] = {
        title = "Jail Near",
        icon = "#cuffs-cuff",
        functionName = 'CLIMBRP:JailPlayer'
    }, 
    ['police:unjail'] = {
        title = "Unjail Player",
        icon = "#cuffs-uncuff",
        functionName = "CLIMBRP:UnJailPlayer"
    }, 

    ['police:fine'] = {
        title = "Fine Nearest",
        icon = "#animation-money",
        functionName = 'CLIMBRP:Fine'
    }, 
    ['police:seize'] = {
        title = "Seize Weapons",
        icon = "#police-action-remove-weapons",
        functionName = 'CLIMBRP:SeizeWeapons2'
    }, 
--[[     ['police:seizeitems'] = {
        title = "Seize Items",
        icon = "#police-action-remove-weapons",
        functionName = 'CLIMBRP:SeizeWeapons'
    },  ]]
    ['cuffs:softcuff'] = {
        title = "Soft Cuff",
        icon = "#cuffs-cuff",
