...
dealership.free = {
    {spawncode = "hycadeurus", vehname = "CLIMB Hycade Urus", price = 0, desciption = "Vehicle Weight: (30kg)"},
}

dealership.vehicles = {
    {spawncode = "ap2", vehname = "Honda AP2", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "488", vehname = "Ferrari 488", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "is350", vehname = "Lexus IS350", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "19gt500", vehname = "Ford Mustang Shelby GT500", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "8c", vehname = "Alfa Romeo C8", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "4c", vehname = "Alfa Romeo C4 Spiderz", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "argiu", vehname = "Alfa Romeo Giulietta", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "rapide", vehname = "Aston Martin Rapide", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "rs5", vehname = "Audi RS5 2011", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "r820", vehname = "Audi R8", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "bcgt2014", vehname = "Bently GT", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "I8", vehname = "BMW I8", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "bolide", vehname = "Bugatti Bolide", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "cgts", vehname = "Bently CGTS", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "C7", vehname = "Corvette C7", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "czr1", vehname = "Corvette CZR1", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "SALEEN", vehname = "Ford Saleen", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "HONDACIVICTR", vehname = "Honda Civic", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "KOUP", vehname = "Kia Forte", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "LP750SV", vehname = "Lamborghini LP750SV", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "LP700", vehname = "lamborghini Aventador", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "URUS", vehname = "lamborghini Urus", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "levante", vehname = "Maserati Levante", price = 400000 , desciption = "Vehicle Weight: (30kg)"},

    {spawncode = "2011mazda2", vehname = "Mazda HR", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "na6", vehname = "Mazda MX5", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "amggt", vehname = "Mercedes AMG", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "evo9mr", vehname = "Mitsubishi Evo", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "skyline", vehname = "Nissan Skyline", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "qashqai16", vehname = "Nissan Qashqai", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "pgt3", vehname = "Porsche 911", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "regera", vehname = "Koenigsegg Regera", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "ren_clio_5", vehname = "Renault Clio", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "twizy", vehname = "Renault Twinzy", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "subwrx", vehname = "Subaru Impreza", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "celica", vehname = "Toyota Celica", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "fj40", vehname = "Toyota Land", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
    {spawncode = "golfgti", vehname = "Volkswagen Golf", price = 400000 , desciption = "Vehicle Weight: (30kg)"},
...
RMenu.Add("DealershipMenu", "vehicles", RageUI.CreateSubMenu(RMenu:Get('DealershipMenu', 'main',  1300, 50)))
RMenu.Add("DealershipMenu", "free", RageUI.CreateSubMenu(RMenu:Get('DealershipMenu', 'main',  1300, 50)))
...
RageUI.CreateWhile(1.0, RMenu:Get('DealershipMenu', 'main'), nil, function()
    RageUI.IsVisible(RMenu:Get('DealershipMenu', 'main'), true, false, true, function()
            ...
            if hasRebel then 
                RageUI.ButtonWithStyle('~d~Rebel Vehicles', nil, { RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
                    if Selected then
                    end
...
RageUI.CreateWhile(1.0, RMenu:Get('DealershipMenu', 'sim'), nil, function()
    RageUI.IsVisible(RMenu:Get('DealershipMenu', 'sim'), true, false, true, function()
        ...
        RageUI.ButtonWithStyle('vehicles', nil, { RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
            if Selected then
            end
        end, RMenu:Get("DealershipMenu", "vehicles"))
       
        RageUI.ButtonWithStyle('free', nil, { RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
            if Selected then
            end
...
RageUI.CreateWhile(1.0, RMenu:Get('DealershipMenu', 'rebel'), nil, function()
    RageUI.IsVisible(RMenu:Get('DealershipMenu', 'rebel'), true, false, true, function()
        RageUI.Separator("Currently Viewing: " .. '~d~Rebel Vehicles', function() end)
        for i , p in pairs(dealership.rebel) do 
            RageUI.ButtonWithStyle("~d~"..p.vehname, p.desciption, {RightLabel =  "~g~£" .. tostring(p.price) }, true, function(Hovered, Active, Selected)
                if Selected then
                    cPrice = p.price
                    cHash = p.spawncode
                end
...
RageUI.CreateWhile(1.0, RMenu:Get('DealershipMenu', 'vehicles'), nil, function()
    RageUI.IsVisible(RMenu:Get('DealershipMenu', 'vehicles'), true, false, true, function()
        RageUI.Separator("Currently Viewing: " .. 'Dealership Vehicles', function() end)
        for i , p in pairs(dealership.vehicles) do 
...
RageUI.CreateWhile(1.0, RMenu:Get('DealershipMenu', 'free'), nil, function()
    RageUI.IsVisible(RMenu:Get('DealershipMenu', 'free'), true, false, true, function()
        RageUI.Separator("Currently Viewing: " .. 'Dealership Vehicles', function() end)
        for i , p in pairs(dealership.free) do 
            RageUI.ButtonWithStyle(p.vehname, p.desciption, {RightLabel =  "~g~£" .. tostring(p.price) }, true, function(Hovered, Active, Selected)
                if Selected then
                    cPrice = p.price
                    cHash = p.spawncode
